...
def runsim(theta):
  ...
  #PLOT
  with open("./plotResults/mini/mini_results.csv", "a") as file_object:
  ...
  plt.legend()
  str_output = './plotResults/mini/fig_' + str(it_ - 1) + '.png' 
...
result = minimize(runsim, [550005,-200006,50001,100001, -100002, 1], method='Nelder-Mead', bounds=bnds)
print(result)
# runPlot(model, vad)
# runCSV(model, vad)